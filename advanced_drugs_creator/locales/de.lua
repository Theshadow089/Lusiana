locales['de'] = {
    ...
    ['sold'] = "Du hast x%d %s für $%s verkauft",
    ...
    ['remain_to_sell'] = "Bleibe auf der %ds Höhe um die Drogen zu verkaufen",
    ['timer'] = "Warte %ds sekunden, um die Drogen zu Verkaufen",
    ...
    ["it_will_explode"] = "Das Labor wird in ein paar Sekunden hochgehen, LAUF",
    ["explosion_in_zone"] = "Es war eine EXPLOSION in %s",
    ['wrong_items'] = "Du hast falsche Zutaten verwendet",
    ['ingredient_taken'] = "Du hast x%d %s geerntet",
    ['press_to_sell'] = "Drücke E um zu Verkaufen",
    ['drug_not_wanted'] = "Die Person möchte keine Drogen kaufen",
    ['sold_for'] = "Du hast x%d %s für $%s verkauft",
    ['someone_tried_to_sell_drugs'] = "Jemand hat versucht Drogen zu verkaufen",
    ['not_enough_police'] = "Zu wenige Polizisten sind anwesend",
    ['gang_member'] = "Gangmitglied",
    ['this_is_our_zone'] = "Das ist unser Gebiet!",
    ['citizen'] = "Bürger",
    ...
    ['drug_has_been_stolen'] = "Deinex%d %s wurden dir gestohlen! Hole sie wieder zurück!",
    ...
    ['narcos:sold_drug'] = "Du hast x%d %s für $%s verkauft",
    ...
    ["canceled_sale"] = "Verkauf wurde abgebrochen",
	["you_crafted"] = "Du hast x%d %s hergestellt",
    ...
    ["pusher:sold"] = "Du hast x%d %s für $%s verkauft",
